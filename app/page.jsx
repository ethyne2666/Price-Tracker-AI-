    ...
    <main className="min-h-screen bg-linear-to-br from-orange-50 via-white to-orange-50">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-6 py-2 rounded-full text-sm font-medium mb-6"> Made with ❤️ by NullLogic</div>
          <h2 className="text-5xl font-bold text-gray-900 mb-4 tracking-tight">Never Miss a price Drop</h2>

          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Track prices from any e-commerece site. Get instant alerts when prices drop.Save money effortlessly.
          </p>
      ...
      { user && products.length === 0 && (
        <section className="max-w-2xl mx-auto px-4 pb-20 text-center">
          <div className="bg-white rounded-xl border-2 border-dashed border-gray-300 p-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Product yet</h3>
